...
// index to store the current word count
// Loop for each character in s until a space is encountered
//  - continously add each character to result string
//  - add one to count, if count == k, return result string
