...
*/
// APPROACH: Initialize variable to store the number of passengers
// who are seniors. Get the substring from details that denotes
// the age of the passenger. Add all the passengers over 60 years
#include <iostream>
