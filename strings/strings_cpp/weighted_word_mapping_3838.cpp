...
// APPROACH: Create a string to store the result
// Create mapping for the reverse alphabetic order
// Loop and find the sum of the weights of each word's
// characters, also find the modulo 26 and add appropriate value
// to the result.
string mapWordWeights(vector<string>& words, vector<int>& weights) {
    string res = ""; int cIdx = 122;
    map<int, char> rAlphabet;
