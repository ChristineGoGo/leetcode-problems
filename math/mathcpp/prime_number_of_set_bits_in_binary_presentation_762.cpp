/*
    ...
    count of numbers in the inclusive range [left, right]
...
using namespace std;
// APPROACH : Only need primes upto 19 and helper function
// to find the setBits
// R < 10^ 6(so opportunity of setbits reaching only 19)
