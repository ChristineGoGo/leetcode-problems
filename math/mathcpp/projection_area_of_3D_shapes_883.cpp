/*
    ...
    A projection is like a shadow, that maps our 3-dimensional figure to
     a 2-dimensional plane. We are viewing the "shadow" when looking at the 
...
// APPROACH: Find the maximum of each row, maximum of each column and 
// sum of all the elements and add them all together
