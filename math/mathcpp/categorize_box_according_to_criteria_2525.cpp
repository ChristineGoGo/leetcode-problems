/*
    ...
    mass, representing the dimensions and mass of a box,
...
// APPROACH: Use a vector to track if Bulky or Heavy
string categorizeBox(int length, int width, int height, int mass) {
    ...
    if (length >= bulky || width >= bulky || height>= bulky || volume >= 1000000000 ) {
