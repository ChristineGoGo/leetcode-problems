/*
    ...
    You are given an integer purchaseAmount representing the 
    amount you will spend on a purchase in dollars, in other words, its price.

    When making the purchase, first the purchaseAmount is rounded to
    the nearest multiple of 10. Let us call this value roundedAmount. 
...
public class accountBalanceAfterRoundedPurchase_2806 {
    public int accountBalanceAfterPurchase(int purchaseAmount) {
        int lDigit = purchaseAmount % 10;

        if (lDigit < 5) {
            purchaseAmount -= lDigit;
        } else {
