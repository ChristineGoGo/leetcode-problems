/*
    ...
    to determine the number of distinct three-digit even numbers that
    can be formed using these digits.

    Note: Each copy of a digit can only be used once per number, and
    ...
    are 124, 132, 134, 142, 214, 234, 312, 314, 324, 342, 412, and 432. 
