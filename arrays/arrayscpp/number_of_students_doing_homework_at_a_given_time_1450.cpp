/*
    ...
    3 and wasn't doing anything at time 4.
...
// APPROACH: Loop for each student i and compare the end time and start time
// and if either occur durring query time given,  add to the total number of 
