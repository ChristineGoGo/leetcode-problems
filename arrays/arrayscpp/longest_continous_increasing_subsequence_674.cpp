/*
    ...
    5 and 7 are separated by element 4.
...
// APPROACH: Create a variable to store the longest increasing
// subsequence count.Use two pointers to find the requirement
int findLengthOfLCIS(vector<int>& nums) {
    int count = 1; int n = nums.size(); int cCount = 1;
    int left = 0; int right = 1; int start = 0;
