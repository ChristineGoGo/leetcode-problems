...
// APPROACH: Calculate the sum of all numbers
// Balance the right and left sums through
// subtraction and additions and return the middle index once it is found
