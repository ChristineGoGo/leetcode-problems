/*
    ...
    each of length n, where fruits[i] represents the quantity of 
...
// APPROACH: Track all the fruits placed by subtracting one from
// the total fruits whenever it is placed and having the basket capacity
// to equal 0
int numOfUnplacedFruits(vector<int>& fruits, vector<int>& baskets) {
    int totFruits = fruits.size();
